...
class FredMeyerCoupons(CouponBaseStore):
    _store_name: str = 'fredmeyer-coupons'
    ...
    async def scrape(self):
        async with httpx.AsyncClient(timeout=90, transport=self.httpx_transport) as client:
            ...
            headers = {
                ...
                'referer': 'https://www.fredmeyer.com/savings/cl/coupons/',
                'sec-ch-ua': '"Google Chrome";v="123", "Not:A-Brand";v="8", "Chromium";v="123"',
                'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36',
            }

            response = await client.post(
                'https://www.fredmeyer.com/cl/api/coupons',
                params=params,
                json=json_data,
                timeout=90,
                headers=headers,
